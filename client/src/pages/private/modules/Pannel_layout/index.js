...
import MemberM from '../../components/member-manage';
//import MemberV from '../../components/presentation-view';
//import MemberU from '../../components/UpdatePresentation';
...
export default function Layout() {
    ...
    useEffect(() => {
        ...
        store.subscribe(() => {
            setUsers(store.getState().adminUserHome.users);
        })
    ...
    const panelNav = ()=>{
        return (
            <>
                <List>
                    <Link to='/member-manage' className='text-link'>
                    <ListItem disablePadding>
                     ...
                     {/* <Link to='/presentation-view' className='text-link'>
                     <ListItem disablePadding>
                        <ListItemButton>
                            <ListItemIcon>
                                <ScheduleSendIcon/>
                            </ListItemIcon>
                            <ListItemText primary={'Evaluate Presentation'}/>
                        </ListItemButton>
                    </ListItem>
        </Link>  */}
